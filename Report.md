...
Non avendo mai lavorato con la programmazione ad oggetti questo progetto si è rivelato una sfida molto importante, non solo per lo studio del linguaggio per se, ma anche nell'affrontare gli ostacoli dello sviluppo di un progetto software di gruppo: coordinamento, sistemi di controllo versione, leggere codice di altri, inoltre ho capito l'importanza dell'analisi del problema e del design della soluzione, i quali se fatti bene possono portare a un ingente decremento del lavoro futuro. Avendoci suddiviso il lavoro in parti simili, ognuno aveva un' interfaccia e la propria logica da implementare, è stato abbastanza facile poter proseguire autonomamente con il lavoro senza dover dipendere troppo dai progressi degli altri colleghi, pur dovendo sempre rimanere aggiornati sulla loro parte.
