 ...
 * It have methods to open different scenes and to set and get the primary
 * stage.
 * 
...
public class SceneControllerSingleton implements ISceneController {
    ...
    /**
     * Opens the match scene. If the screen resolution is not supported, an error
     * message is shown to the user and the application is closed.
     * 
